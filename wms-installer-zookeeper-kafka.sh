...
#sudo sed -i 's/\(log.dirs=\)/log.dirs=/'$WMS_KAFKA_LOG' \1/g' /data/kafka_2.11-2.2.1/config/server.properties
#log.dirs=/tmp/kafka-logs
#zookeeper.connect=localhost:2181
#sudo sed -i 's/\(#advertised.listeners=\)/advertised.listeners=PLAINTEXT://your.host.name:9092\1/g' /data/kafka_2.11-2.2.1/config/server.properties
#sed 's/\(#advertised.listeners=\)/'$WMS_KAFKA'\1/g' /data/kafka_2.11-2.2.1/config/server.properties
